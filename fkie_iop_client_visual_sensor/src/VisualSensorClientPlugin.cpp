...
#include "VisualSensorClientPlugin.h"
...
VisualSensorClientPlugin::VisualSensorClientPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* VisualSensorClientPlugin::get_service()
{
	return p_my_service;
}

void VisualSensorClientPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new VisualSensorClientService(jaus_router, p_transport_service, p_events_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::VisualSensorClientPlugin, iop::PluginInterface)
