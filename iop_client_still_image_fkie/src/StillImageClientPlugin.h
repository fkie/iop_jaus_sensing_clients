...
#ifndef STILLIMAGECLIENTPLUGIN_H
#define STILLIMAGECLIENTPLUGIN_H

#include "urn_jaus_jss_environmentSensing_StillImageClient/StillImageClientService.h"
...
class DllExport StillImageClientPlugin : public PluginInterface
{
public:
	StillImageClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_environmentSensing_StillImageClient::StillImageClientService *p_my_service;
