...
#ifndef RANGESENSORCLIENTPLUGIN_H
#define RANGESENSORCLIENTPLUGIN_H

#include "urn_jaus_jss_environmentSensing_RangeSensorClient/RangeSensorClientService.h"
...
class DllExport RangeSensorClientPlugin : public PluginInterface
{
public:
	RangeSensorClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_environmentSensing_RangeSensorClient::RangeSensorClientService *p_my_service;
